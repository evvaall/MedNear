...
class Vendas(base.Model):
    ...
    preço = base.Column(base.Float, nullable=False)
    quantidade = base.Column(base.Integer, nullable=False, default=0)
    data = base.Column(base.String(10), nullable=False)
    hora = base.Column(base.String(50), nullable=False)
    user_id = base.Column(base.Integer, base.ForeignKey('farmacia.id'), nullable=False)
    adicionado_por_id = base.Column(base.Integer, base.ForeignKey('funcionario.id'), nullable=False)
    funcionario = base.relationship('Funcionario', backref='medicamentos_adicionados', lazy=True)
    obs =  base.Column(base.String(50), nullable=False)
    categoria = base.Column(base.String(50), nullable=False)

    def __init__(self, nome, preço, quantidade, user_id, data, obs, categoria, hora, adicionado_por_id, funcionario):
        self.nome = nome
        self.user_id = user_id
        self.quantidade = quantidade
        self.data = data
...
class Historia(base.Model):
    ...
    data = base.Column(base.String(250), nullable=False)
    hora = base.Column(base.String(50), nullable=False)
    user_id = base.Column(base.Integer, base.ForeignKey('farmacia.id'), nullable=False)
    tipo = base.Column(base.String(50), nullable=False)
    def __init__(self,tipo, data, descricao, user_id, hora):
...
class Funcionario(base.Model):
    ...
    telefone_whatsapp = base.Column(base.String(15), nullable=False)
    user_id = base.Column(base.Integer, base.ForeignKey('farmacia.id'), nullable=False)
    def __init__(self, nome, user_id, senha, nivel_acesso, telefone_whatsapp):
        self.nome = nome
        self.user_id = user_id
